...
def cmd_aquarium(args) -> None:
    aquarium.main(task_label=args.label, duration=args.duration)
...
def build_parser() -> argparse.ArgumentParser:
    ...
    aq_p = sub.add_parser("aquarium", help="Mostra o aquário ASCII (splash/idle screen do SuperCode)")
    aq_p.add_argument("--label", default=None, help="Texto mostrado no topo da tela")
    aq_p.add_argument("--duration", type=float, default=None, help="Duração em segundos (default: até apertar 'q')")
    aq_p.set_defaults(func=cmd_aquarium)
